        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 flex items-center justify-between h-12 text-xs md:text-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <p className="font-semibold text-primary hidden sm:block">
                  Al Babtain Building - Office 302 - Port Saeed - Deira - Dubai - United Arab Emirates
                </p>
          ...
          <div className="flex items-center gap-4 text-text-light">
            <div className="hidden sm:flex items-center gap-3">
              <a href="https://www.facebook.com/FermiumDesigns" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-primary transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/all_dubai_authority_approvals/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-primary transition-colors">
              ...
              <a href="https://www.linkedin.com/company/fermium-designs/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-primary transition-colors">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            >
              ...
              <div className={`transition-colors duration-500 ${isScrolled ? "text-primary" : "text-white"}`}>
                ...
                <p className="text-sm font-semibold">+971 52 254 3903</p>
              </div>
            </a>
          </div>
