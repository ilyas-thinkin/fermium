...
function TestimonialCard({ text, author, role }: (typeof testimonials)[0]) {
  return (
    <div className="flex-shrink-0 w-[500px] md:w-[600px] px-8 py-10 border border-border bg-white/90 rounded-2xl shadow-[0_18px_40px_rgba(0,0,0,0.08)]">
      <svg className="w-8 h-8 text-accent/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
        <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10H14.017zM0 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151C7.546 6.068 5.983 8.789 5.983 11H10v10H0z" />
      </svg>
      <p className="text-lg md:text-xl font-body text-text-primary leading-relaxed mb-6">&ldquo;{text}&rdquo;</p>
      <div>
  ...
  return (
    <section className="py-24 md:py-32 bg-bg-secondary overflow-hidden">
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 mb-16">
        ...
        <h2 className="text-4xl md:text-5xl font-display font-bold text-text-primary">What Our Clients Say</h2>
      </div>
