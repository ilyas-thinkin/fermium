    ...
    <main>
      ...
      <section className="relative bg-[#0D1A3A] pt-40 pb-0 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
          <Link href="/structural" className="inline-flex items-center gap-2 text-white/35 hover:text-white/70 text-xs font-bold uppercase tracking-widest transition-colors mb-12">
