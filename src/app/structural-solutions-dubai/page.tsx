...
const servicesData: StructuralService[] = [
  {
    ...
    detailHref: "/structural-design-drafting-dubai",
  },
  {
    id: "2",
    icon: "analysis",
    ...
    detailHref: "/structural-analysis-dubai",
  },
  {
    id: "3",
    icon: "document",
    ...
    detailHref: "/calculations-reports-dubai",
  },
  {
    id: "4",
    icon: "approval",
    ...
    detailHref: "/structural-authority-approvals-dubai",
  },
  {
    id: "5",
    icon: "model",
    ...
    detailHref: "/3d-bim-modeling-dubai",
  },
  {
    id: "6",
    icon: "supervision",
    ...
    detailHref: "/site-supervision-dubai",
  },
];
