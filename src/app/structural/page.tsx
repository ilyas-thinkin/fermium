...
const servicesData: StructuralService[] = [
  {
    ...
    detailHref: "/structural/structural-design-drafting-dubai",
  },
  {
    id: "2",
    icon: "analysis",
    ...
    detailHref: "/structural/structural-analysis-dubai",
  },
  {
    id: "3",
    icon: "document",
    ...
    detailHref: "/structural/calculations-reports-dubai",
  },
  {
    id: "4",
    icon: "approval",
    ...
    detailHref: "/structural/structural-authority-approvals-dubai",
  },
  {
    id: "5",
    icon: "model",
    ...
    detailHref: "/structural/3d-bim-modeling-dubai",
  },
  {
    id: "6",
    icon: "supervision",
    ...
    detailHref: "/structural/site-supervision-dubai",
  },
];
