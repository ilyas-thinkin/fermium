        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {contactDetails.map((item) => (
              ...
              >
                <span className="w-14 h-14 rounded-xl bg-accent/10 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-all duration-300 shrink-0">
                  {item.icon}
                </span>
                <div>
                  <p className="text-sm font-bold uppercase tracking-widest text-accent mb-1">{item.label}</p>
                  <p className="text-base text-primary font-semibold whitespace-pre-line leading-snug">{item.value}</p>
                </div>
              </a>
            ))}
          </div>
      ...
      <section className="py-20 bg-primary">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 text-center">
          ...
          <p className="text-white/60 mb-8 max-w-md mx-auto">
            Call or WhatsApp us directly — we&apos;re available Monday to Friday, 9 AM – 6 PM.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+971522543903"
              className="inline-flex items-center justify-center gap-2.5 px-7 py-4 bg-white text-primary text-sm font-semibold rounded-lg hover:bg-accent hover:text-white transition-colors duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2.5 px-7 py-4 bg-accent text-white text-sm font-semibold rounded-lg hover:bg-white hover:text-primary transition-colors duration-300"
            >
