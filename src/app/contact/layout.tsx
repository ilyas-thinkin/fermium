...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.fermiumdesigns.ae/contact",
  },
  openGraph: {
    title: "Contact Fermium Designs | Fitout Approvals & Project Management Services Dubai",
    ...
    url: "https://www.fermiumdesigns.ae/contact",
    siteName: "Fermium Designs",
    locale: "en_AE",
    type: "website",
    images: [{ url: "https://www.fermiumdesigns.ae/Images/hero/corporate.webp", width: 1200, height: 630, alt: "Contact Fermium Designs" }],
  },
  twitter: {
