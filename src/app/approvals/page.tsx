...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://fermiumdesigns.ae/approvals",
  },
  openGraph: {
    title: "Authority Approvals in Dubai | Fermium Designs",
    description:
      "Get expert authority approvals in Dubai with Fermium Designs. We support property owners, contractors, and fitout teams with reliable Dubai approvals and project management services.",
    url: "https://fermiumdesigns.ae/approvals",
    siteName: "Fermium Designs",
    locale: "en_AE",
    type: "website",
    images: [{ url: "https://fermiumdesigns.ae/Images/hero/corporate.webp", width: 1200, height: 630, alt: "Authority Approvals Dubai" }],
  },
  twitter: {
