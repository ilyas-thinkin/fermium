export default function BlogContent() {
  return (
    <div className="blog-content-wrapper">
      ...
      <p><span className="text-color-white">TestColumn</span> 1</p>
      ...
      <ul>
        <li>DCD Approval Services in Dubai -&gt; &#123; /<em>$merge: &#123; /<em>$merge: &#123;&#123;website_url&#125;&#125;</em>/ &#125;</em>/ &#125;/dcd-approval</li>
        <li>Dubai Authority Approvals -&gt; &#123; /<em>$merge: &#123; /<em>$merge: &#123;&#123;website_url&#125;&#125;</em>/ &#125;</em>/ &#125;/authority-approvals</li>
        <li>Fitout Approvals Dubai -&gt; &#123; /<em>$merge: &#123; /<em>$merge: &#123;&#123;website_url&#125;&#125;</em>/ &#125;</em>/ &#125;/fitout-approvals</li>
        <li>Project Management Services -&gt; &#123; /<em>$merge: &#123; /<em>$merge: &#123;&#123;website_url&#125;&#125;</em>/ &#125;</em>/ &#125;/project-management</li>
        <li>DM Approval -&gt; &#123; /<em>$merge: &#123; /<em>$merge: &#123;&#123;website_url&#125;&#125;</em>/ &#125;</em>/ &#125;/dm-approval</li>
      </ul>
