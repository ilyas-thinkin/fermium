export default function BlogContent() {
  return (
    <div className="blog-content-wrapper">
      ...
      <h2><strong>How to Get Dubai Civil Defence Approval - Step-by-Step Process</strong></h2>

      <h3><strong>1) Define the project scope clearly</strong></h3>
      ...
      <h3><strong>2) Prepare compliant drawings</strong></h3>
      ...
      <h3><strong>3) Check materials and equipment approvals</strong></h3>
      ...
      <h3><strong>4) Submit through the official DCD smart services route</strong></h3>
      ...
      <h3><strong>5) Address review comments carefully</strong></h3>
      ...
      <h3><strong>6) Install exactly as approved</strong></h3>
      ...
      <h3><strong>7) Complete inspection and final approval</strong></h3>
      ...
      <h2><strong>What DCD Checks During Review</strong></h2>
      ...
      <h2><strong>Common Reasons for Rejection or Delay</strong></h2>
      ...
      <h3><strong>Real-world insight</strong></h3>
      ...
      <h2><strong>Practical Tips to Speed Up Approval</strong></h2>

      <ul>
        <li>Start fire and life safety planning at the concept stage</li>
