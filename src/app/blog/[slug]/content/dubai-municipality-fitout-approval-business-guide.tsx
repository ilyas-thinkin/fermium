export default function BlogContent() {
  return (
    <div className="blog-content-wrapper">
      ...
      <p>Before DM submission, most buildings (and all master-developer properties) require the building management or developer NOC. This confirms the landlord has reviewed and approved your fit-out scope and methods. Some developers (Emaar, Nakheel, DAMAC) have their own full review process that takes 1–4 weeks.</p>
      ...
      <div classname="timeline-table">
        <table>
          ...
          <tbody>
            <tr><td>Drawing preparation</td><td>1–2 weeks</td></tr>
            <tr><td>Building management NOC</td><td>1–4 weeks</td></tr>
            <tr><td>DM initial review</td><td>1–2 weeks</td></tr>
            <tr><td>Comment responses</td><td>3–7 days per round</td></tr>
            <tr><td>DM permit issued</td><td>3–5 days after final approval</td></tr>
            <tr><td>Completion inspection</td><td>5–10 days after request</td></tr>
          </tbody>
        </table>
      </div>
