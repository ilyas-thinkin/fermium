...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaTitle: 'How to Get Dubai Civil Defence Approval (DCD approval) 2026 | Fermium Designs',
...

  {
    ...
    metaTitle: '10 Common Fitout Approval Mistakes in Dubai | Fermium Designs',
...

  {
    ...
    metaTitle: 'Dubai Development Authority Approval (DDA): Complete Guide | Fermium Designs',
...

  {
    ...
    metaTitle: 'How to get Dubai Municipality Approval (DM approval) 2026 | Fermium Designs',
